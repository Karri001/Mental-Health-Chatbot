...
const HomePage = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p>
          <strong>MentalHealthAI</strong> is a <span style={{color:"red", fontWeight:"bold"}} > Mental Health Care Chatbot </span> and is here to provide you with a
        ...
        <p>
          ...
          <strong style={{color:"red"}}>MentalHealthAI</strong> is available <span style={{color:"red", fontWeight:"bold"}} > 24/7 </span> to assist you with empathetic and personalized
          support.
        </p>
      </div>
      ...
      <footer className="text-center mt-5">
        <p style={{ color: 'gold', fontSize: '1rem' }}>
          Created with by 😊 <span style={{color:"red", fontWeight:"bold"}} > Students of AIML ..! </span>
        </p>
      </footer>
    </div>
  );
